...
std::ostream& operator<<(std::ostream& os, const point_vector& ps); // Imprimir un vector de puntos
std::ostream& operator<<(std::ostream& os, const point& ps); // Imprimir un punto

std::istream& operator>>(std::istream& is, point_vector& ps); // Leer los vectores de puntos
std::istream& operator>>(std::istream& is, point& ps); // Leer un punto